...
#region Functions
Function Remove-ComputerRestorePoints {
<#
.SYNOPSIS
...
.EXAMPLE
    Get-ComputerRestorePoint | Remove-ComputerRestorePoints -WhatIf
#>
...
Try {
    ...
    $Searcher.FindAll() | ForEach-Object{$PasswordLastSet=[datetime]::FromFileTime($_.Properties['pwdlastset'][0])}
}
Catch {
...
Get-ComputerRestorePoint | Where-Object {$_.ConvertToDateTime($_.CreationTime) -lt  $PasswordLastSet} | Remove-ComputerRestorePoints
